...
const layerCategories: LayerCategory[] = [
  {
    ...
    items: [
      ...
      { id: 'puskesmas',   label: 'Puskesmas', color: '#2f8f83' },
      { id: 'klinik',     label: 'Klinik', color: '#78a94a' },
      { id: 'apotek',  label: 'Apotek', color: '#1f6b45' },
      { id: 'homecare',    label: 'HomeCare Lansia', color: '#b08a3e' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'communityReports', label: 'Laporan Warga', color: '#1f6b45' },
