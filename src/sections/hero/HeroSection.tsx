...
export function HeroSection() {
  return (
    <section id="hero" className="relative overflow-hidden bg-surface-100 px-2 py-2 sm:px-3 sm:py-3 lg:px-4 lg:py-4">
      <div className="relative mx-auto max-w-[1600px] overflow-hidden rounded-[18px] bg-white shadow-[0_22px_80px_rgba(41,48,44,0.16)]">
        ...
        <div className="relative min-h-[calc(100svh-3rem)] overflow-hidden">
          ...
          <div className="absolute inset-y-0 left-0 w-full bg-[#f7f4ed]/74 sm:w-[68%] sm:bg-[#f7f4ed]/64" />
          <div className="absolute left-0 top-0 h-full w-[42%] bg-white/10 backdrop-blur-[2px]" />
            ...
            >
              <div className="mb-5 flex flex-wrap items-center gap-2">
                {insightItems.map((item) => (
                  <span
                    key={item}
                    className="rounded-full border border-brand-green/15 bg-white/55 px-3 py-1 text-[11px] font-semibold uppercase text-brand-green-dark shadow-[0_6px_24px_rgba(31,107,69,0.08)] backdrop-blur-xl sm:text-xs"
                  >
                    {item}
                  </span>
                ))}
              ...
              <h1 className="max-w-[560px] text-5xl font-normal leading-[0.95] tracking-normal text-ink-800 sm:text-6xl lg:text-7xl xl:text-8xl">
                Buka Peta
                <br />
                Kesehatan
                <br />
              ...
              <p className="mt-5 max-w-[440px] text-sm font-medium leading-snug text-ink-900 sm:text-base">
